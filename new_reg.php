<?php include('server/server_new.php') ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="container">
            <div class="row g-5">
                                ...
                                <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                                    <div class="carousel-inner">
                                      <!-- <div class="carousel-item active">
                                        <img class="img-fluid position-relative w-60 h-60" id="slide" src="img/tom.png" alt=""  style="object-fit: contain;">
                                      </div> -->
                                      <div class="carousel-item active">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s" id="reg-page">
                    ...
                    <form  action="new_reg.php"  method="post">
   
                        <div class="border-1 shadow-lg" id="form-cover">
                            <div class="input-container">
                                <div class="mb-3" id="input-cover-select"> 
                                    <label for="exampleFormControlInput1" class="form-label">Title</label>
                                   <select class="form-select" aria-label="Default select example" name="title"  id="input"s>
                        ...
                        <div class="input-container">
                            <div class="mb-3" id="input-cover"> 
                              ...
                              <div class="mb-3" id="input-cover"> 
                                ...
                                <input type="text" class="form-control" id="input" name="lastname"  value="<?php echo $firstname; ?>"   placeholder="Enter your last name">
                              </div>
                        </div>
                        <div class="input-container">
                            <div class="mb-3" id="input-cover"> 
                        ...
                        <div class="input-container">
                              ...
                              <div class="mb-3" id="input-cover-lg"> 
                                ...
                                <input type="text" class="form-control" id="input-lg" name="location"   placeholder="Location and nearest bus-stop">
                              </div>
                        </div>
                        <input type="submit" class="form-control" name="new_reg" id="submit-btn">
                    </div>
                    </form>
