            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;" id="slide-page">
                    <div class="position-relative h-100">
                        ...
                        <img class="img-fluid position-absolute w-100 h-100" src="img/rowvirtuous.png" alt="" style="object-fit: contain;">
                    </div>
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s" id="reg-page">
                    ...
                    <form  action="reg_virtuous.php"  method="post">
                        ...
                        <div class="input-container">
                            <div class="mb-3" id="input-cover"> 
                              ...
                              <div class="mb-3" id="input-cover" style="display:none"> 
                                <label for="exampleFormControlInput1" class="form-label">Last name</label>
                                <input type="text" class="form-control" id="input" name="my_group"  value="VIRTUOUS"  placeholder="Enter your last name">
                              </div>
                        </div>
                        <div class="input-container">
