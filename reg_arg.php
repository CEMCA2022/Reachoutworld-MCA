            ...
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s" id="reg-page">
                    ...
                    <center>
                     ...
                     <center style=""><?php echo "<div id=\"prompt0\">".$erremail."</div>"; ?></center>
                     <center style=""><?php echo "<div id=\"prompt0\">".$messagesSuccess."</div>"; ?></center>
                     <div><?php echo $errors.$successMessage;?></div>
                    <h1 class="mb-4"> Registration Portal</h1>
                   
                    <form  action="reg_arg.php"  method="post">
                        ...
                        <div class="input-container">
                            <div class="mb-3" id="input-cover"> 
                              ...
                              <div class="mb-3" id="input-cover" style="display:none"> 
                                <label for="exampleFormControlInput1" class="form-label">Last name</label>
                                <input type="text" class="form-control" id="input" name="my_group"  value="AIRPORT ROAD"  placeholder="Enter your last name">
                              </div>
                        </div>
                        <div class="input-container">
                            <div class="mb-3" id="input-cover"> 
