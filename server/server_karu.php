...
// Page footer
	...
	// $userAddress = $row['userAddress'];
		...
		elseif (count($errors) == 0) {
		   ...
		   $messagesSuccess = '<p style="background-color:red; color:white; border-radius:5px; font-size:10px; margin-top:8px; line-height:18px; padding:5px">Congratulations!' .$firstname.' Congratulations! Registration sucessful, Your REG CODE is' .$reg_code.' check ' .$email.' for details<p>';
}
