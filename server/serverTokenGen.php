...
session_start();
	...
	$farmers = fetchFromDatabase('localhost', 'tanalyqo_admin', 'WjAnU1SDcJH5', 'tanalyqo_qualityrice', 'token_table');
	$status = 0;
	// connect to database
	...
	if (isset($_POST['pad'])) {	
		...
		$errpassword_1 = '<p style="background-color:red; color:white; border-radius:4px; font-size:10px; margin-top:8px; line-height:18px; padding:5px">Please Agent Password should be Minimum of 11 Characters</p>';
		array_push($errors, $errpassword_1);}


		if (empty($email_1)) {
			$erremail = '<p style="background-color:red; color:white; border-radius:4px; font-size:10px; margin-top:8px; line-height:18px; padding:5px">New Agent Email Address is required</p>';
			array_push($errors, $erremail);
		}

		if (!filter_var($email_1, FILTER_VALIDATE_EMAIL)) {
			$erremail = '<p style="background-color:red; color:white; border-radius:4px; font-size:10px; margin-top:8px; line-height:18px; padding:5px">Email Address Entered is Invalid or Incorrect</p>';
			array_push($errors, $erremail);}
			...
			$query = "SELECT * FROM token_table WHERE  email='$email_1'";
			...
			if (mysqli_num_rows($results) > 0 ) {
					$erremail = '<p style="background-color:red; color:white; border-radius:4px; font-size:10px; margin-top:8px; line-height:18px; padding:5px">Sorry Token has been Previously Generated to Agent with this Email address </p>';
					array_push($errors, $erremail);
				}
			...
			if ($password_1 != $masterPass) {
				$errpassword_1 = '<p style="background-color:red; color:white; border-radius:4px; font-size:10px; margin-top:8px; line-height:18px; padding:5px">Sorry the Admin Password is Incorrect </p>';
				array_push($errors, $errpassword_1);
			}
		...
		// register user if there are no errors in the form
			...
			if(!empty($token)){
      		...
      		InsertToken('localhost', 'tanalyqo_admin', 'WjAnU1SDcJH5', 'tanalyqo_qualityrice', 'token_table', $token, $email_1);
			// updateTokenTable('localhost', 'ebube', 'advancegrace', 'tanadi', 'token_table', $token);
			$messagesSuccess = '<p style="background-color:red; color:white; border-radius:4px; font-size:10px; margin-top:8px; line-height:18px; padding:5px"> Congratulations! Admin , Your TOKEN is'.$token.' ask agent to check '.$email_1.' for details</p>';
...
$mail->AddAddress($email_1, '');     // Add a recipient
...
<tr>
<td style="font-family:Open Sans,Georgia, Times New Roman, Times, serif, Arial; font-size:14px; color:#767676; font-weight:normal; line-height:32px;" mc:edit="nm10-06" valign="middle" align="left"><multiline> <span style=" font-size:14px; color:black; font-weight: bolder; text-transform:capitalize">Dear ' .$email_1.'</span> <br></multiline></td>
</tr>
<tr>
<td style="font-family:Open Sans,Georgia, Times New Roman, Times, serif, Arial; font-size:14px; color:#767676; font-weight:normal; line-height:20px;" mc:edit="nm10-06" valign="middle" align="left"><multiline> <span style=" font-size:15px; color:#000000;">Thank you for expressing interest in Qualityrice.ng </span> </td>
</tr>
<tr>
<td style="font-family:Open Sans,Georgia, Times New Roman, Times, serif, Arial; font-size:14px; color:#ff0000; text-transform:uppercase;" mc:edit="nm10-03" valign="middle" align="left"><multiline style=" ">Below is your Token for your Registration as an Agent </multiline></td>
</tr>
...
<tr>
<td style="font-family:Open Sans,Georgia, Times New Roman, Times, serif, Arial; font-size:16px; color:#000000;  text-transform:capitalize;" mc:edit="nm10-03" valign="middle" align="left"><multiline style="color:black;"> Token:' .$token.'</multiline></td>
</tr>
<tr>
<td><br></td>
</tr>
...
<tr>
<td style="font-family:Open Sans,Georgia, Times New Roman, Times, serif, Arial; font-size:16px; color:#000000;  text-transform:capitalize;" mc:edit="nm10-03" valign="middle" align="left"><multiline style="color:black;"> Creation Date: '.$date->format('d-m-Y H:i:s').'</multiline></td>
</tr>
<tr>
<td><br></td>
</tr>
<tr>
<td style="font-family:Open Sans,Georgia, Times New Roman, Times, serif, Arial; font-size:12px; color:#ff0000; text-transform:capitalize;" mc:edit="nm10-03" valign="middle" align="center"><multiline style=" font-weight:bold; text-transform: capitalize">Kindly treat your token as Confidential, and avoid sharing of the token</multiline></td>
</tr>
<tr>
<td><br></td>
</tr>
